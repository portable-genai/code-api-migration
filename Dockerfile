# Code and API Migration Copilot (H5) serving image.
#
...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    CODEMIGRATION_PROFILE=gcp \
    CODEMIGRATION_SETTINGS=/app/config/settings.yaml \
    PORT=8080
...
CMD ["sh", "-c", "python -m code_api_migration.managed_readiness && exec uvicorn code_api_migration.api.app:app --host 0.0.0.0 --port ${PORT:-8080}"]
