...
from .ci_status import CiStatusPort
...
from .repo_access import RepoAccessPort
from .repo_scanner import RepoScannerPort
...
PORT_PROTOCOLS: dict[str, type] = {
    ...
    "repo_scanner": RepoScannerPort,
    "repo_access": RepoAccessPort,
    "ci_status": CiStatusPort,
