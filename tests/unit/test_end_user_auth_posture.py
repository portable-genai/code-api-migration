...
read
    ...
    bind_profile == local AND profile chosen AND CODEMIGRATION_S2S_TOKEN unset
...
from code_api_migration.adapters.local.identity import (
    LocalIdentityAdapter,
)
from code_api_migration.adapters.onprem.identity import (
